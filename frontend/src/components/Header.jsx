...
//   return (
//     <header className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700 px-6 py-3">
//       <div className="flex items-center justify-between">
...
//           {/* <button
//             onClick={toggleTheme}
//             className="px-4 py-1.5 text-sm rounded-md transition bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200"
//           >
